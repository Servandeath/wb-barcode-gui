...
Дружелюбная Windows-утилита для создания этикеток, наклеек и стикеров
**58×40 мм** со штрихкодом **EAN-13** из Excel-выгрузки Wildberries.

![Мастер этикеток](docs/preview.png)

![Главное окно «Мастера этикеток»](docs/main001.png)
